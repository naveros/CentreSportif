...
namespace CentreSportifSylvestre
{
    public partial class _Membre : Page
    {
        ...
        protected void InscriptionActivite(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Inscription")
            {
                ...
                {
                    cn.Open();
                    queryStr = "INSERT INTO centresportif420.abonnement (idpersonne, idgroupe, dateinscription, datefin, prix) VALUES ('" + (String)(Session["idpersonne"]) + "', '" + randomNumber + "', '" + DateTimeToUnixTimestamp(date) + "', '" + DateTimeToUnixTimestamp(date) + "', '" + 50 + "')";
