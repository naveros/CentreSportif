<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Horaires.aspx.cs" Inherits="CentreSportif.Horaires" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
        <asp:GridView ID="GVhoraire" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" Height="251px" HorizontalAlign="Center" Width="876px">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Nom du professeur">
                    <EditItemTemplate>
                        <asp:TextBox ID="txtnomProf" runat="server" Text='<%# Eval("name") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
